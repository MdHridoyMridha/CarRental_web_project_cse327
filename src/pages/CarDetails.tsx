  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      notificationService.sendBookingConfirmation({
        ...
        carName: car?.name || 'Your selected car',
        status: 'confirmed',
        startDate,
        endDate,
        totalPrice,
          ...
          <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
            <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
              ...
              <div className="text-right">
                <span className="text-3xl font-black text-indigo-600">{TAKA_SYMBOL}{car.price_per_day}</span>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-indigo-50 rounded-2xl border border-indigo-100">
                  <div>
                    ...
                    <p className="text-[10px] text-indigo-600 font-medium uppercase tracking-wider">Extra {TAKA_SYMBOL}{car.driver_fee}/day</p>
                  </div>
                  <button
                    type="button"
                ...
                <div className="pt-6 border-t border-gray-100 space-y-3">
                  <div className="flex justify-between text-gray-600">
                    ...
                    <span className="font-bold">{TAKA_SYMBOL}{days > 0 ? days * car.price_per_day : 0}</span>
                  </div>
                  {withDriver && (
                    <div className="flex justify-between text-gray-600">
                      <span>Driver Fee ({days > 0 ? days : 0} days)</span>
                      <span className="font-bold">{TAKA_SYMBOL}{days > 0 ? days * car.driver_fee : 0}</span>
                    </div>
                  )}
                  <div className="flex justify-between text-gray-600">
                    <span>Service Fee</span>
                    <span className="font-bold">{TAKA_SYMBOL}0</span>
                  </div>
                  <div className="flex justify-between text-xl font-black text-gray-900 pt-3">
                    <span>Total</span>
                    <span>{TAKA_SYMBOL}{totalPrice > 0 ? totalPrice : 0}</span>
                  </div>
                </div>
